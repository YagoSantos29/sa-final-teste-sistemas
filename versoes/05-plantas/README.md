# Loja de Plantas Raiz & Folha — S.A. Final (em grupo)
...
Você recebeu o front-end de uma **loja de plantas** em React que **funciona, mas chegou
...
cd sa-final-teste-sistemas/versoes/05-plantas
