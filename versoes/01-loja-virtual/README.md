# Loja Virtual — S.A. Final (em grupo)
...
Você recebeu o front-end de uma **loja virtual** em React que **funciona, mas chegou
...
cd sa-final-teste-sistemas/versoes/01-loja-virtual
